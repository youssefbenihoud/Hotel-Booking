...
const Footer = () => {
  return (
    <footer className="bg-black">
      ...
      <div className="bg-lime-500 py-10 px-6 md:px-20 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-black">
          ...
          <p className="text-lg opacity-80">
            Get the latest updates and special deals straight to your inbox.
          </p>
        </div>
      ...
      {/* Bottom Section */}
      <div className="max-w-7xl mx-auto py-16 px-6 md:px-20 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Brand & Socials */}
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-400 leading-relaxed">
            Experience luxury and comfort in the heart of Morocco. Your perfect
            stay awaits you at Marokko Hotel.
          </p>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-xl font-bold mb-6 border-b-2 border-lime-400 inline-block">
            Quick Links
          </h3>
